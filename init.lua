...
require('lazy').setup({
  ...
  -- buat nampilin suggestion, misal ngetikin c doang atau ci doang akan tampil variasi keyboard yang bisa ditekan selanjutnya
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sf', builtin.find_files, { desc = '[S]earch [F]iles' }) -- ketika pilih file, lalu ctrl + 6 buat bolak balik
